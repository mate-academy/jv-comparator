...
public class EmployeeServiceTest {
    ...
    public void employeeService_sortByAge() {
        Set<Employee> actualResult = employeeService.getEmploeeByOrder(employeesOfDifferentAges);
    ...
    public void employeeService_sortByName() {
        Set<Employee> actualResult = employeeService.getEmploeeByOrder(employeesOfSameAges);
        Assert.assertEquals("The size of sorted set should the same as the size of input list",
    ...
    public void employeeService_sortByAgeAndName() {
        Set<Employee> actualResult = employeeService.getEmploeeByOrder(employeesOfDifferentAgesAndNames);
        Assert.assertEquals("The size of sorted set should the same as the size of input list",
    ...
    public void employeeService_emplyList() {
        Set<Employee> actualResult = employeeService.getEmploeeByOrder(new ArrayList<>());
        Assert.assertEquals("The size of sorted set should the same as the size of input list",
                0, actualResult.size());
    }
